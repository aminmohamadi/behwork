...
class UserRepository implements UserRepositoryInterface, ConfigRepository , ACLRepository
{
    ...
    {
        return $user->certificates()->updateOrCreate(['certificate_id' => $certificate_id, 'transcript_id' => $transcript_id,'code'=>$this->generateUniqueReferralCode()], []);
    }
    ...
    protected function generateUniqueReferralCode($length = 8)
    {
        do {
